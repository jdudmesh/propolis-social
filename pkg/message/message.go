...
const (
	MessageSubTypeText MessageSubType = "text/plain"
	MessageSubTypeJSON MessageSubType = "application/json"
)
...
func New(payload interface{}, senderAddress Address, messageSubType MessageSubType, privateKey *ecdsa.PrivateKey) (string, string, error) {
	if payload == nil {
...
func Parse(raw string, publicKeyFn PublicKeyFn) (*Message, error) {
	m := &Message{
		Header:  Header{},
		Payload: []byte{},
